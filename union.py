...
sql_query = pd.read_sql_query ('''
    SELECT
    CH_Fact_Heat_d.bildings_id as bild, CH_Fact_Heat_d.date as datetime,
    CH_Fact_Heat_d.fact_heat_ch as fact, Calc_Heat_d.bildings_id, Calc_Heat_d.date,
    Calc_Heat_d.calc_heat_d as calc, Calc_Heat_d.temp_out, Bildings.name as bildname
    FROM CH_Fact_Heat_d
    JOIN Calc_Heat_d
